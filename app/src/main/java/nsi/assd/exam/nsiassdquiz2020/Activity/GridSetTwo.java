...
import static nsi.assd.exam.nsiassdquiz2020.Adapter.InterstitialAdHelper.mInterstitialAd;
...
public class GridSetTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("https://aesecurityguard.com/nsi-quiz2/");
    }
            ...
            public void handleOnBackPressed() {
                if (webView.canGoBack()) {
                    ...
                    if (mInterstitialAd != null) {
                        mInterstitialAd.show(GridSetTwo.this);
                    } else {
